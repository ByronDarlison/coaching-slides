...
MEETINGS[3] = {
    ...
    "fixed_hw_cum": 112,
    "deliverables": [
        D("Key Function Flow Map (KFFM)", "▲", "symbol-evolution", 8, 20,
        ...
        D("Functional Organization Chart (FOC)", "▲", "symbol-evolution", 8, 28,
          article="https://www.darlison.com/how-your-company-makes-money/",
          prompt="https://www.darlison.com/kffm-tools/",
        ...
        D("3-Year Highly Achievable Goal (3HAG)", "★", "symbol-introduced", 20, 68,
        ...
        D("1-Year Highly Achievable Goal (1HAG)", "★", "symbol-introduced", 16, 84,
          article="https://www.darlison.com/where-are-you-going/",
          prompt="https://www.darlison.com/planning-cascade-prompt/",
          image_key="one_hag",
          points=[
...
MEETINGS[4] = {
    ...
    "deliverables": [
        ...
        D("QHAG + Sprint Lanes", "✓", "symbol-confirm", 3, 18,
          ...
          prompt="https://www.darlison.com/planning-cascade-prompt/",
          image_key="q_hag"),
        D("Key Function Flow Map (KFFM)", "▲", "symbol-evolution", 6, 24,
          article="https://www.darlison.com/how-your-company-makes-money/",
          prompt="https://www.darlison.com/kffm-tools/",
          image_key="pillar_hr_kffm",
          points=[
        ...
        D("Functional Organization Chart (FOC)", "▲", "symbol-evolution", 6, 30,
          article="https://www.darlison.com/how-your-company-makes-money/",
          prompt="https://www.darlison.com/kffm-tools/",
          image_key="pillar_hr_foc",
          points=[
    ...
    "homework": [
        ...
        ("Read Ahead and Complete the ✦ AI Prompts for M5", [
            ("Function Scorecards ★", "https://www.darlison.com/scorecards/", None),
